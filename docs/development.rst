...
authors pin dependency on ``sphinx_radiac_theme`` to a version below the next major
version:

.. code:: console

    $ pip install "sphinx_radiac_theme<=2.0.0"
...
HTML4 support will be removed
    ...
    your dependency to ``sphinx_radiac_theme<=2.0.0`` until you can.
